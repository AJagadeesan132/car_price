...
def prediction(car_df, car_width, engine_size, horse_power, drivewheel_fwd, car_comp_buick):
	x = car_df.iloc[:, :-1]
	y = car_df["price"]
	x_train, x_test, y_train, y_test = train_test_split(x, y, test_size = 0.3, random_state = 42)
	linreg = LinearRegression().fit(x_train, y_train)
	score = linreg.score(x_train, y_train)
	price = linreg.predict([[car_width, engine_size, horse_power, drivewheel_fwd, car_comp_buick]])
	price = price[0]
	...
	return price, score, r2_score, mae, mse, msle
